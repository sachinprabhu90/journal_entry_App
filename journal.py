...
class Journal():
    def __init__(self, master):
        ...
        ttk.Label(master, text='Location: ', style='TLabel').grid(
        ...
        self.text_entry = Text(
            ...
            font=(self.config['text_field']['font'],self.config['text_field']['font_size'])
        ...
        self.customise_button = HoverButton(master,text="Customise", 
                                        background=self.config['button']['background'], 
                                        foreground=self.config['button']['foreground'],
                                        command=lambda : self.customize(master))
        self.customise_button.grid(row=3, column=3, sticky='NE', padx=10, pady=5)
    ...
    def customize(self,master):
        ...
        ttk.Label(self.cust_window, text='Main Background:', style='TLabel').grid(row=0, column=0, padx=2, pady=2)
        ttk.Label(self.cust_window, text='Entry Foreground:').grid(row=1, column=0, padx=2, pady=2)
        ttk.Label(self.cust_window, text='Entry Background:').grid(row=2, column=0, padx=2, pady=2)
        ttk.Label(self.cust_window, text='Label Foreground:').grid(row=3, column=0, padx=2, pady=2)
        ttk.Label(self.cust_window, text='Label Background:').grid(row=4, column=0, padx=2, pady=2)
        ttk.Label(self.cust_window, text='Button Foreground:').grid(row=5, column=0, padx=2, pady=2)
        ttk.Label(self.cust_window, text='Button Background:').grid(row=6, column=0, padx=2, pady=2)
        ttk.Label(self.cust_window, text='Journal Entry Foreground:').grid(row=7, column=0, padx=2, pady=2)
        ttk.Label(self.cust_window, text='Journal Entry Background:').grid(row=8, column=0, padx=2, pady=2)
    ...
    def write_config(self):
        ...
        messagebox.showinfo(title='Info', message='Please restart the application for the changes to take effect')
    ...
    def populate_entries(self):
        ...
        self.journal_background.insert(0,self.config['text_field']['background'])
        self.journal_foreground.insert(0,self.config['text_field']['foreground'])
